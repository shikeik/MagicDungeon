...
*   **核心类引用**:
    *   `com.goldsprite.magicdungeon2.world.Dungeon`: 地图数据容器。
    *   `com.goldsprite.magicdungeon2.core.renderer.DualGridDungeonRenderer`: 地图渲染器。
    *   `com.goldsprite.magicdungeon2.entities.Monster`: 怪物实体。
    *   `com.goldsprite.magicdungeon2.entities.Item`: 物品实体。
