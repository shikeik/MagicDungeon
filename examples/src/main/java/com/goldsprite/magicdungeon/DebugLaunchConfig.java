...
public class DebugLaunchConfig {
    ...
    public static Class<? extends GScreen> targetScreen = NeonSkelEditorScreen.class;
    
    /** 自动测试类 (仅在 AUTO_TEST 模式下有效) */
    public static Class<? extends IGameAutoTest> autoTestClass = NeonSkelEditorAutoTest.class;
