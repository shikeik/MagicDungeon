...
import com.goldsprite.magicdungeon2.screens.tests.netcode.NetcodeTankOnlineScreen;
import com.goldsprite.magicdungeon2.screens.tests.netcode.NetcodeTankSandboxScreen;
import com.goldsprite.magicdungeon2.screens.tests.netcode.SupabaseLobbyScreen;
...
public class TestSelectionScreen extends BaseSelectionScreen {
	...
	protected void initScreenMapping(Map<String, Class<? extends GScreen>> map) {
		...
		map.put("Netcode坦克联机(纯内网)", NetcodeTankOnlineScreen.class);
		map.put("Netcode坦克大厅(Supabase)", SupabaseLobbyScreen.class);
