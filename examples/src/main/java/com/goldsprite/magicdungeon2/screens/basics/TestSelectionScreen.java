...
public class TestSelectionScreen extends BaseSelectionScreen {
        ...
        protected void initScreenMapping(Map<String, Class<? extends GScreen>> map) {
                ...
                map.put("Netcode坦克联机对战", NetcodeTankOnlineScreen.class);
                map.put("Netcode UDP服务端(旧)", NetcodeUdpServerScreen.class);
                map.put("Netcode UDP客户端(旧)", NetcodeUdpClientScreen.class);
