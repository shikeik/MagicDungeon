package com.goldsprite.magicdungeon.screens.ecs.hub.mvp;
...
import com.goldsprite.magicdungeon.screens.ecs.hub.SettingsWindow;
import com.goldsprite.magicdungeon.ui.event.ContextListener;
import com.goldsprite.magicdungeon.ui.widget.BaseDialog;
import com.goldsprite.magicdungeon.ui.widget.IDEConsole;
...
public class HubViewImpl extends VisTable implements IHubView {
	...
	private void launchDocServer() {
		try {
			...
			String url = com.goldsprite.magicdungeon.core.web.DocServer.getIndexUrl() + "?v=" + BuildConfig.DEV_VERSION;
		...
		public CreateProjectDialog() {
			...
			pkgField.addListener(new ChangeListener() {
					...
					public void changed(ChangeEvent event, Actor actor) {
						...
						if (!com.goldsprite.magicdungeon.core.project.ProjectService.isValidPackageName(currentPkg)) {
